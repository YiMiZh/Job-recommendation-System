(function() {
   ...
   * Variables
   */
  // Default for test, will be replaced after user log in.
  var user_id = '1111';
  var user_fullname = 'yiming';
  var lng = -122.08;
  var lat = 37.38;
  ...
  function init() {
    ...
    document.querySelector('.top-nav').getElementsByTagName("a")[1].addEventListener('click', showContactInfo);
    document.querySelector('.top-nav').getElementsByTagName("a")[0].addEventListener('click', validateSession);
  ...
  function ajax(method, url, data, successCallback, errorCallback) {
    ...
    // 2. Configure it: request for the URL
   ...
   *
   * Here is an example. Don't need to worry about the style. Css file have already implemented it.
   <li class="item">
